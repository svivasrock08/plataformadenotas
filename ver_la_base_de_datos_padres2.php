...
<body>
	...
	<div id="container">
		...
		<div id="centro">
			<h3>ver la base de datos padres</h3>
			<table border="1";>
				<tr><th> ID</th><th> nombre</th><th> apellido</th><th> usuario</th>
					<th> correo</th><th> ciudad</th><th> fecha de nacimiento</th><th> elimina</th><th> modificar</th>

			<?php
			require "php/a_mantenet_laconexion_a_mysq.php";

			$GetUser4 = mysql_query("SELECT * FROM  historial_padre");
			...
			$ciudad=mysql_result($GetUser4, $deri,"padre_ID");
			
			echo "<tr><td>$ID</td><td>$nombre</td><td>$apellido</td><td>$usuario</td><td>$correo</td><td>$ciudad</td>";
			echo "<td><a href='php/eliminaadmdo.php?id=$ID'> Elimina</a></td><td><a href='modificaradmdo.php?id=$ID'> Modificar</a></td></tr>";
