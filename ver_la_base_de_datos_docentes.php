...
<body>
	...
	<div id="container">
		...
		<div id="centro">
			<h3>ver la base de datos de los docentes</h3>
			<table border="1";>
			...
			$GetUser4 = mysql_query("SELECT * FROM  profesores");
			...
			echo "<td>$fechanac</td><td><a href='php/eliminaadmdo.php?id=$ID'> Elimina</a></td><td><a href='modificaradmdo.php?id=$ID'> Modificar</a></td></tr>";
